...
<!-- 分页标签库 -->
<%@ taglib prefix="farsight" uri="http://farsight.cn/common/"%>
<%
...
<body>
	...
	<div id="wrapper">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="index.html">客户管理系统 v1.0</a>
		</div>
		<!-- /.navbar-header -->
		...
		<ul class="nav navbar-top-links navbar-right">
			<li class="dropdown"><a class="dropdown-toggle"
				...
				<ul class="dropdown-menu dropdown-messages">
					<li><a href="#">
							<div>
								<strong>jack</strong> <span class="pull-right text-muted">
									<em>今天</em>
								</span>
							</div>
							<div>美好的一天开始了</div>
			...
			<li class="dropdown"><a class="dropdown-toggle"
				...
				<ul class="dropdown-menu dropdown-user">
					...
					<li class="divider"></li>
					<li><a href="<%=basePath %>admin/loginOut.action"><i class="fa fa-sign-out fa-fw"></i>
							退出登录</a></li>
				</ul> <!-- /.dropdown-user --></li>
			<!-- /.dropdown -->
		</ul>
		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li><a href="salevisit.action"><i
							class="fa fa-dashboard fa-fw"></i>员工管理</a></li>
					<li><a href="salevisit.action"><i
							class="fa fa-dashboard fa-fw"></i>权限管理</a></li>		
				</ul>
			</div>
			<!-- /.sidebar-collapse -->
		</div>
		...
		<div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-body">
					<form class="form-inline" action="<%=basePath %>customer/list.action" method="post">
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
								...
								<c:forEach items="${page.rows}" var="row">
									<tr>
										...
										<td>
											...
											<a href="#" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#customerEditDialog" onclick="editCustomer(${row.cust_id})">修改</a>
						...
						<div class="col-md-12 text-center">
							<farsight:page url="${pageContext.request.contextPath }/customer/list.action" />
						</div>
						<!-- /.panel-body -->
					</div>
					<!-- /.panel -->
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" onclick="doAddCustomer()">新增保存</button>
	...
	<div class="modal fade" id="customerEditDialog" tabindex="-2" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
					<button type="button" class="btn btn-primary" onclick="updateCustomer()">修改保存</button>
	...
	<script src="<%=basePath%>js/sb-admin-2.js"></script>
		...
		function deleteCustomer(id) {
			if(confirm('确实要删除该客户吗?')) {
				$.post(
						"<%=basePath%>customer/delete.action",
						{"id":id},
						function(data){
							alert("客户删除更新成功！");
							window.location.reload();
